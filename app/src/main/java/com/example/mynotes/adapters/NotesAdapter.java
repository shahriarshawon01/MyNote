...
public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.NoteViewHolder> {
    ...
    static class NoteViewHolder extends RecyclerView.ViewHolder {
        ...
        NoteViewHolder(@NonNull View itemView) {
            ...
            textSubtitle = itemView.findViewById(R.id.textSubtitleId);
            textDateTime = itemView.findViewById(R.id.textDateTime_itemId);
            layoutNote = itemView.findViewById(R.id.layoutNoteId);
            roundedImageNote = itemView.findViewById(R.id.roundedImageNoteId);
        }
